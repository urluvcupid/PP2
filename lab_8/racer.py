...
background = pygame.image.load("lab_8/raceGo/Street.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab_8/raceGo/car2.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab_8/raceGo/car1.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab_8/raceGo/coin.png")
        self.rect = self.image.get_rect()
...
while not done:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("lab_8/raceGo/crash.wav")
        time.sleep(1)
